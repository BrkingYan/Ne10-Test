...
void cdft_int(int n, int isgn, int *a)
{
    void cftfsub(int n, int *a);
    void cftbsub(int n, int *a);
...
void rdft(int n, int isgn, int *a)
{
    void cftfsub(int n, int *a);
    void cftbsub(int n, int *a);
    void rftfsub(int n, int *a);
    void rftbsub(int n, int *a);
    int xi;
...
void ddct(int n, int isgn, int *a)
{
    void cftfsub(int n, int *a);
    void cftbsub(int n, int *a);
    void rftfsub(int n, int *a);
    void rftbsub(int n, int *a);
    void dctsub(int n, int *a);
    void dctsub4(int n, int *a);
    int j;
    int xr;
...
void ddst(int n, int isgn, int *a)
{
    void cftfsub(int n, int *a);
    void cftbsub(int n, int *a);
    void rftfsub(int n, int *a);
    void rftbsub(int n, int *a);
    void dstsub(int n, int *a);
    void dstsub4(int n, int *a);
    int j;
    int xr;
...
void dfct(int n, int *a)
{
    void ddct(int n, int isgn, int *a);
    void bitrv1(int n, int *a);
    int j, k, m, mh;
    int xr, xi, yr, yi, an;
...
void cftfsub(int n, int *a)
{
    void bitrv2(int n, int *a);
    void bitrv216(int *a);
    void bitrv208(int *a);
    void cftmdl1(int n, int *a);
    void cftrec4(int n, int *a);
    void cftleaf(int n, int isplt, int *a);
    void cftfx41(int n, int *a);
    void cftf161(int *a);
    void cftf081(int *a);
    void cftf040(int *a);
    void cftx020(int *a);
#ifdef USE_CDFT_THREADS
    void cftrec4_th(int n, int *a);
...
void cftbsub(int n, int *a)
{
    void bitrv2conj(int n, int *a);
    void bitrv216neg(int *a);
    void bitrv208neg(int *a);
    void cftb1st(int n, int *a);
    void cftrec4(int n, int *a);
    void cftleaf(int n, int isplt, int *a);
    void cftfx41(int n, int *a);
    void cftf161(int *a);
...
void bitrv216(int *a)
{
    int x1r, x1i, x2r, x2i, x3r, x3i, x4r, x4i,
...
void bitrv208(int *a)
{
    int x1r, x1i, x3r, x3i, x4r, x4i, x6r, x6i;
...
void *cftrec1_th(void *p)
{
    int cfttree(int n, int j, int k, int *a);
    void cftleaf(int n, int isplt, int *a);
    void cftmdl1(int n, int *a);
...
void cftmdl2(int n, int *a)
{
    ...
    int x0r, x0i, x1r, x1i, x2r, x2i, x3r, x3i, y0r, y0i, y2r, y2i;
...
void cftf161(int *a)
{
    float wn4r, wk1r, wk1i;
        ...
        int y4r, y4i, y5r, y5i, y6r, y6i, y7r, y7i;
        int y8r, y8i, y9r, y9i, y10r, y10i, y11r, y11i;
        int y12r, y12i, y13r, y13i, y14r, y14i, y15r, y15i;
...
void cftf162(int *a)
{
    ...
    int x0r, x0i, x1r, x1i, x2r, x2i, y0r, y0i, y1r, y1i, y2r, y2i, y3r, y3i, y4r, y4i, y5r, y5i, y6r, y6i, y7r, y7i, y8r, y8i, y9r, y9i, y10r, y10i, y11r, y11i;
    int y12r, y12i, y13r, y13i, y14r, y14i, y15r, y15i;
...
{
    float wn4r;
    int x0r, x0i, x1r, x1i, x2r, x2i, x3r, x3i,y0r, y0i, y1r, y1i, y2r, y2i, y3r, y3i,y4r, y4i, y5r, y5i, y6r, y6i, y7r, y7i;
...
{
    float wn4r, wk1r, wk1i;
    int x0r, x0i, x1r, x1i,y0r, y0i, y1r, y1i, y2r, y2i, y3r, y3i, y4r, y4i, y5r, y5i, y6r, y6i, y7r, y7i;
...
{
    int i, i0, j, k;
    float ec, w1r, w1i, wkr, wki, wdr, wdi, ss;
    int xr, xi, yr, yi;
